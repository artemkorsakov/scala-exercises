...
class TermsAndTypesTestSuite extends AnyFunSuiteLike with Matchers {
  test("test Scala Tutorial LIB section TermsAndTypes 0") {
    1 + 2 shouldBe 3

    "Hello, " ++ "Scala!" shouldBe "Hello, Scala!"
  }

  test("test Scala Tutorial LIB section TermsAndTypes 1") {
    "Hello, Scala!".toUpperCase shouldBe "HELLO, SCALA!"

    -42.abs shouldBe 42
  }

  test("test Scala Tutorial LIB section TermsAndTypes 2") {
