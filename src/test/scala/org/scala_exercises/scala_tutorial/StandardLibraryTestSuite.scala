...
class StandardLibraryTestSuite extends AnyFunSuiteLike with Matchers {
  test("test STD LIB section StandardLibrary 0") {
  ...
  test("test STD LIB section StandardLibrary 4") {
