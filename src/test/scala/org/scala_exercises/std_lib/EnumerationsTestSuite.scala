...
class EnumerationsTestSuite extends AnyFunSuiteLike with Matchers {
  test("test STD LIB section Enumerations 0") {
  ...
  test("test STD LIB section Enumerations 1") {
  ...
  test("test STD LIB section Enumerations 2") {
    object Planets extends Enumeration {
  ...
  test("test STD LIB section Enumerations 3") {
    object GreekPlanets extends Enumeration {
  ...
  test("test STD LIB section Enumerations 4") {
    object Planets extends Enumeration {
      ...
      class PlanetValue(val i: Int, val name: String, val mass: Double, val radius: Double)
        ...
        def compare(that: PlanetValue): Int = this.i - that.i
      }
