...
class FoldableTestSuite extends AnyFunSuiteLike with Matchers {
  ...
  test("test CATS LIB section Foldable 11") {
  ...
  test("test CATS LIB section Foldable 12") {
